...
/**
 * Class Campaign Version v2019_1
 * 
 * Model for Campaign
 *
 * @property integer $id
 ...
 * @property Spinen\ConnectWise\Models\v2019_1\Marketing\CampaignSubTypeReference $subType
 * @property Spinen\ConnectWise\Models\v2019_1\Marketing\CampaignStatusReference $status
 * @property string $startDate
 * @property string $endDate
 * @property integer $locationId
 * @property Spinen\ConnectWise\Models\v2019_1\Marketing\MemberReference $member
 * @property boolean $inactive
 * @property integer $inactiveDaysAfterEnd
 * @property string $notes
 * @property Spinen\ConnectWise\Models\v2019_1\Marketing\GroupReference $defaultGroup
...
class Campaign extends Model
{
    ...
    protected $casts = [
        ...
        'subType' => 'Spinen\ConnectWise\Models\v2019_1\Marketing\CampaignSubTypeReference',
        'status' => 'Spinen\ConnectWise\Models\v2019_1\Marketing\CampaignStatusReference',
        'startDate' => 'string',
        'endDate' => 'string',
        'locationId' => 'integer',
        'member' => 'Spinen\ConnectWise\Models\v2019_1\Marketing\MemberReference',
        'inactive' => 'boolean',
        'inactiveDaysAfterEnd' => 'integer',
        'notes' => 'string',
        'defaultGroup' => 'Spinen\ConnectWise\Models\v2019_1\Marketing\GroupReference',
