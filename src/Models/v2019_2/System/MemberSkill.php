...
class MemberSkill extends Model
{
    ...
    protected $casts = [
        ...
        'notes' => 'string',
        'skill' => 'Spinen\ConnectWise\Models\v2019_2\System\SkillReference',
        'skillLevel' => 'string',
