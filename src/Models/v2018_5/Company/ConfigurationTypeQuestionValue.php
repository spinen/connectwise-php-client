 ...
 *
 * @property Spinen\ConnectWise\Models\v2018_5\Company\ConfigurationTypeQuestionReference $question
...
class ConfigurationTypeQuestionValue extends Model
{
    ...
    protected $casts = [
        ...
        'question' => 'Spinen\ConnectWise\Models\v2018_5\Company\ConfigurationTypeQuestionReference',
        'value' => 'string',
    ];
}
