 ...
 *
 * @property integer $id
 * @property Spinen\ConnectWise\Models\v2018_5\Time\TimePeriodSetupReference $timePeriodSetup
...
class TimePeriod extends Model
{
    ...
    protected $casts = [
        'id' => 'integer',
        'timePeriodSetup' => 'Spinen\ConnectWise\Models\v2018_5\Time\TimePeriodSetupReference',
        'period' => 'integer',
        'startDate' => 'string',
        'endDate' => 'string',
        'deadlineDate' => 'string',
