 ...
 *
 * @property integer $id
 * @property Spinen\ConnectWise\Models\v2018_4\Company\PortalConfigurationReference $portalConfig
...
class PortalConfigurationProjectSetup extends Model
{
    ...
    protected $casts = [
        'id' => 'integer',
        'portalConfig' => 'Spinen\ConnectWise\Models\v2018_4\Company\PortalConfigurationReference',
