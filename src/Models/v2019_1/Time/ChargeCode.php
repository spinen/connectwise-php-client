 ...
 * @property Spinen\ConnectWise\Models\v2019_1\Time\SystemDepartmentReference $department
...
class ChargeCode extends Model
{
    ...
    protected $casts = [
        ...
        'department' => 'Spinen\ConnectWise\Models\v2019_1\Time\SystemDepartmentReference',
        'billTime' => 'string',
