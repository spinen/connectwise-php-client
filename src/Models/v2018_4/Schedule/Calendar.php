...
/**
 * Class Calendar Version v2018_4
 *
 * Model for Calendar
 *
 * @property integer $id
 * @property string $name
 * @property Spinen\ConnectWise\Models\v2018_4\Schedule\HolidayListReference $holidayList
...
class Calendar extends Model
{
    ...
    protected $casts = [
        'id' => 'integer',
        'name' => 'string',
        'holidayList' => 'Spinen\ConnectWise\Models\v2018_4\Schedule\HolidayListReference',
