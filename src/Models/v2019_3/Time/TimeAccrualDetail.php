...
/**
 * Class TimeAccrualDetail Version v2019_3
 *
 * Model for TimeAccrualDetail
 *
 * @property Spinen\ConnectWise\Models\v2019_3\Time\Metadata $_info
 * @property Spinen\ConnectWise\Models\v2019_3\Time\TimeAccrualReference $timeAccrual
...
class TimeAccrualDetail extends Model
{
    ...
    protected $casts = [
        ...
        'id' => 'integer',
        'startYear' => 'integer',
        'timeAccrual' => 'Spinen\ConnectWise\Models\v2019_3\Time\TimeAccrualReference',
    ];
}
