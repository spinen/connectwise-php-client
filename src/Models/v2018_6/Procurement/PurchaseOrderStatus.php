 ...
 * @property Spinen\ConnectWise\Models\v2018_6\Procurement\PurchaseOrderStatusEmailTemplateReference $emailTemplate
...
class PurchaseOrderStatus extends Model
{
    ...
    protected $casts = [
        ...
        'sortOrder' => 'integer',
        'emailTemplate' => 'Spinen\ConnectWise\Models\v2018_6\Procurement\PurchaseOrderStatusEmailTemplateReference',
