...
/**
 * Class CompanyManagementSummary Version v2018_5
 * 
 * Model for CompanyManagementSummary
 *
 * @property integer $id
 * @property Spinen\ConnectWise\Models\v2018_5\Company\ManagementSolutionReference $managementSolution
 * @property string $groupIdentifier
 * @property string $deviceType
 * @property Spinen\ConnectWise\Models\v2018_5\Company\AgreementReference $agreement
...
class CompanyManagementSummary extends Model
{
    ...
    protected $casts = [
        'id' => 'integer',
        'managementSolution' => 'Spinen\ConnectWise\Models\v2018_5\Company\ManagementSolutionReference',
        'groupIdentifier' => 'string',
        'deviceType' => 'string',
        'agreement' => 'Spinen\ConnectWise\Models\v2018_5\Company\AgreementReference',
