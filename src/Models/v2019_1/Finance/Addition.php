...
/**
 * Class Addition Version v2019_1
 *
 * Model for Addition
 *
 * @property integer $id
 * @property Spinen\ConnectWise\Models\v2019_1\Finance\IvItemReference $product
...
class Addition extends Model
{
    ...
    protected $casts = [
        'id' => 'integer',
        'product' => 'Spinen\ConnectWise\Models\v2019_1\Finance\IvItemReference',
        'quantity' => 'float',
        'lessIncluded' => 'float',
        'unitPrice' => 'float',
        'unitCost' => 'float',
