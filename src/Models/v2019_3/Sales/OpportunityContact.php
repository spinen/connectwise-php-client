 ...
 * @property Spinen\ConnectWise\Models\v2019_3\Sales\OpportunitySalesRoleReference $role
...
class OpportunityContact extends Model
{
    ...
    protected $casts = [
        ...
        'role' => 'Spinen\ConnectWise\Models\v2019_3\Sales\OpportunitySalesRoleReference',
    ];
}
