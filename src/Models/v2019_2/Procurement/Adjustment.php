 ...
 * @property Spinen\ConnectWise\Models\v2019_2\Procurement\AdjustmentTypeReference $type
...
class Adjustment extends Model
{
    ...
    protected $casts = [
        'id' => 'integer',
        'identifier' => 'string',
        'type' => 'Spinen\ConnectWise\Models\v2019_2\Procurement\AdjustmentTypeReference',
        'reason' => 'string',
        'notes' => 'string',
        'closedFlag' => 'boolean',
        'closedBy' => 'string',
