 ...
 * @property Spinen\ConnectWise\Models\v2018_6\Company\RelationshipReference $relationship
 * @property string $relationshipOverride
 * @property Spinen\ConnectWise\Models\v2018_6\Company\ContactDepartmentReference $department
 * @property boolean $inactiveFlag
 * @property integer $defaultMergeContactId
 * @property string $securityIdentifier
 * @property Spinen\ConnectWise\Models\v2018_6\Company\ContactReference $managerContact
 * @property Spinen\ConnectWise\Models\v2018_6\Company\ContactReference $assistantContact
...
class Contact extends Model
{
    ...
    protected $casts = [
        ...
        'relationship' => 'Spinen\ConnectWise\Models\v2018_6\Company\RelationshipReference',
        'relationshipOverride' => 'string',
        'department' => 'Spinen\ConnectWise\Models\v2018_6\Company\ContactDepartmentReference',
        'inactiveFlag' => 'boolean',
        'defaultMergeContactId' => 'integer',
        'securityIdentifier' => 'string',
        'managerContact' => 'Spinen\ConnectWise\Models\v2018_6\Company\ContactReference',
        'assistantContact' => 'Spinen\ConnectWise\Models\v2018_6\Company\ContactReference',
        'title' => 'string',
        'school' => 'string',
        'nickName' => 'string',
        'marriedFlag' => 'boolean',
