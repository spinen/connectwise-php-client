...
/**
 * Class GLExportExpense Version v2018_6
 *
 ...
 * @property Spinen\ConnectWise\Models\v2018_6\Finance\GLExportExpenseOffset $offset
 */
class GLExportExpense extends Model
{
    ...
    protected $casts = [
        ...
        'total' => 'float',
        'offset' => 'Spinen\ConnectWise\Models\v2018_6\Finance\GLExportExpenseOffset',
    ];
}
