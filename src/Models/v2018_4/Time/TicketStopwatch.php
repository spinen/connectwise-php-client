 ...
 * @property Spinen\ConnectWise\Models\v2018_4\Time\ServiceStatusReference $serviceStatus
 * @property string $startTime
 * @property string $status
 * @property Spinen\ConnectWise\Models\v2018_4\Time\TicketReference $ticket
 * @property Spinen\ConnectWise\Models\v2018_4\Time\Guid $ticketMobileGuid
...
class TicketStopwatch extends Model
{
    ...
    protected $casts = [
        ...
        'notes' => 'string',
        'serviceStatus' => 'Spinen\ConnectWise\Models\v2018_4\Time\ServiceStatusReference',
        'startTime' => 'string',
        'status' => 'string',
        'ticket' => 'Spinen\ConnectWise\Models\v2018_4\Time\TicketReference',
        'ticketMobileGuid' => 'Spinen\ConnectWise\Models\v2018_4\Time\Guid',
