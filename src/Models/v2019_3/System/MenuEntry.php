...
/**
 * Class MenuEntry Version v2019_3
 * 
 * Model for MenuEntry
 *
 * @property integer $id
 * @property Spinen\ConnectWise\Models\v2019_3\System\MenuLocationReference $menuLocation
...
class MenuEntry extends Model
{
    ...
    protected $casts = [
        'id' => 'integer',
        'menuLocation' => 'Spinen\ConnectWise\Models\v2019_3\System\MenuLocationReference',
        'caption' => 'string',
        'link' => 'string',
