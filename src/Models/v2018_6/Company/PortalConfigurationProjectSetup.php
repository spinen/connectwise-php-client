...
/**
 * Class PortalConfigurationProjectSetup Version v2018_6
 * 
 * Model for PortalConfigurationProjectSetup
 *
 * @property integer $id
 * @property Spinen\ConnectWise\Models\v2018_6\Company\PortalConfigurationReference $portalConfig
...
class PortalConfigurationProjectSetup extends Model
{
    ...
    protected $casts = [
        'id' => 'integer',
        'portalConfig' => 'Spinen\ConnectWise\Models\v2018_6\Company\PortalConfigurationReference',
