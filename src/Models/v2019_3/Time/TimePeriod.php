...
/**
 * Class TimePeriod Version v2019_3
 * 
 * Model for TimePeriod
 *
 * @property integer $id
 * @property Spinen\ConnectWise\Models\v2019_3\Time\TimePeriodSetupReference $timePeriodSetup
...
class TimePeriod extends Model
{
    ...
    protected $casts = [
        'id' => 'integer',
        'timePeriodSetup' => 'Spinen\ConnectWise\Models\v2019_3\Time\TimePeriodSetupReference',
        'period' => 'integer',
        'startDate' => 'string',
        'endDate' => 'string',
        'deadlineDate' => 'string',
