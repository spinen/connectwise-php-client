...
/**
 * Class Workflow Version v2019_2
 *
 * Model for Workflow
 *
 * @property integer $id
 * @property string $name
 * @property Spinen\ConnectWise\Models\v2019_2\System\WorkflowTableTypeReference $tableType
...
class Workflow extends Model
{
    ...
    protected $casts = [
        'id' => 'integer',
        'name' => 'string',
        'tableType' => 'Spinen\ConnectWise\Models\v2019_2\System\WorkflowTableTypeReference',
