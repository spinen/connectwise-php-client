 ...
 *
 * @property integer $id
 * @property Spinen\ConnectWise\Models\v2019_2\Company\ManagementSolutionReference $managementSolution
 * @property string $groupIdentifier
 * @property string $deviceType
 * @property Spinen\ConnectWise\Models\v2019_2\Company\AgreementReference $agreement
...
class CompanyManagementSummary extends Model
{
    ...
    protected $casts = [
        'id' => 'integer',
        'managementSolution' => 'Spinen\ConnectWise\Models\v2019_2\Company\ManagementSolutionReference',
        'groupIdentifier' => 'string',
        'deviceType' => 'string',
        'agreement' => 'Spinen\ConnectWise\Models\v2019_2\Company\AgreementReference',
