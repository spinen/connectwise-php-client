...
/**
 * Class ScheduleStopwatch Version v2019_2
 *
 ...
 * @property Spinen\ConnectWise\Models\v2019_2\Time\Guid $scheduleMobileGuid
...
class ScheduleStopwatch extends Model
{
    ...
    protected $casts = [
        ...
        'notes' => 'string',
        'scheduleId' => 'integer',
        'scheduleMobileGuid' => 'Spinen\ConnectWise\Models\v2019_2\Time\Guid',
