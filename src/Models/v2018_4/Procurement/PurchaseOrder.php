 ...
 * @property Spinen\ConnectWise\Models\v2018_4\Procurement\CompanyReference $customerCompany
 * @property Spinen\ConnectWise\Models\v2018_4\Procurement\ContactReference $customerContact
 * @property Spinen\ConnectWise\Models\v2018_4\Procurement\CountryReference $customerCountry
 * @property string $customerExtension
 * @property string $customerName
 * @property string $customerPhone
 * @property Spinen\ConnectWise\Models\v2018_4\Procurement\SiteReference $customerSite
 ...
 * @property Spinen\ConnectWise\Models\v2018_4\Procurement\TaxCodeReference $taxCode
 * @property boolean $taxFreightFlag
 * @property boolean $taxPoFlag
 * @property Spinen\ConnectWise\Models\v2018_4\Procurement\BillingTermsReference $terms
 * @property float $total
 * @property string $trackingNumber
 * @property boolean $updateShipmentInfo
 * @property boolean $updateVendorOrderNumber
 * @property Spinen\ConnectWise\Models\v2018_4\Procurement\CompanyReference $vendorCompany
 * @property Spinen\ConnectWise\Models\v2018_4\Procurement\ContactReference $vendorContact
 * @property Carbon\Carbon $vendorInvoiceDate
 * @property string $vendorInvoiceNumber
 * @property string $vendorOrderNumber
 * @property Spinen\ConnectWise\Models\v2018_4\Procurement\SiteReference $vendorSite
...
class PurchaseOrder extends Model
{
    ...
    protected $casts = [
        ...
        'closedFlag' => 'boolean',
        'customerCity' => 'string',
        'customerCompany' => 'Spinen\ConnectWise\Models\v2018_4\Procurement\CompanyReference',
        'customerContact' => 'Spinen\ConnectWise\Models\v2018_4\Procurement\ContactReference',
        'customerCountry' => 'Spinen\ConnectWise\Models\v2018_4\Procurement\CountryReference',
        'customerExtension' => 'string',
        'customerName' => 'string',
        'customerPhone' => 'string',
        'customerSite' => 'Spinen\ConnectWise\Models\v2018_4\Procurement\SiteReference',
        ...
        'subTotal' => 'float',
        'taxCode' => 'Spinen\ConnectWise\Models\v2018_4\Procurement\TaxCodeReference',
        'taxFreightFlag' => 'boolean',
        'taxPoFlag' => 'boolean',
        'terms' => 'Spinen\ConnectWise\Models\v2018_4\Procurement\BillingTermsReference',
        'total' => 'float',
        'trackingNumber' => 'string',
        'updateShipmentInfo' => 'boolean',
        'updateVendorOrderNumber' => 'boolean',
        'vendorCompany' => 'Spinen\ConnectWise\Models\v2018_4\Procurement\CompanyReference',
        'vendorContact' => 'Spinen\ConnectWise\Models\v2018_4\Procurement\ContactReference',
        'vendorInvoiceDate' => 'Carbon\Carbon',
        'vendorInvoiceNumber' => 'string',
        'vendorOrderNumber' => 'string',
        'vendorSite' => 'Spinen\ConnectWise\Models\v2018_4\Procurement\SiteReference',
