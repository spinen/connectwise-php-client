...
/**
 * Class OpportunityNote Version v2018_4
 * 
 * Model for OpportunityNote
 *
 * @property integer $id
 * @property integer $opportunityId
 * @property Spinen\ConnectWise\Models\v2018_4\Sales\NoteTypeReference $type
...
class OpportunityNote extends Model
{
    ...
    protected $casts = [
        ...
        'type' => 'Spinen\ConnectWise\Models\v2018_4\Sales\NoteTypeReference',
        'text' => 'string',
        'flagged' => 'boolean',
        'enteredBy' => 'string',
