 ...
 * @property Spinen\ConnectWise\Models\v2019_1\Service\IntegratorLoginReference $integratorLogin
...
class TicketSync extends Model
{
    ...
    protected $casts = [
        ...
        'id' => 'integer',
        'integratorLogin' => 'Spinen\ConnectWise\Models\v2019_1\Service\IntegratorLoginReference',
