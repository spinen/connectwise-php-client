 ...
 * @property Spinen\ConnectWise\Models\v2018_5\System\PortalConfigurationReference $portalConfiguration
...
class PortalReport extends Model
{
    ...
    protected $casts = [
        ...
        'portalConfiguration' => 'Spinen\ConnectWise\Models\v2018_5\System\PortalConfigurationReference',
        'url' => 'string',
    ];
}
