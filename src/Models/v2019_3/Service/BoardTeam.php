...
/**
 * Class BoardTeam Version v2019_3
 *
 * Model for BoardTeam
 *
 * @property integer $id
 * @property string $name
 * @property Spinen\ConnectWise\Models\v2019_3\Service\MemberReference $teamLeader
...
class BoardTeam extends Model
{
    ...
    protected $casts = [
        'id' => 'integer',
        'name' => 'string',
        'teamLeader' => 'Spinen\ConnectWise\Models\v2019_3\Service\MemberReference',
        'members' => 'array',
        'defaultFlag' => 'boolean',
