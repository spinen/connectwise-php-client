 ...
 * @property Spinen\ConnectWise\Models\v2019_2\Sales\OpportunitySalesRoleReference $role
...
class OpportunityContact extends Model
{
    ...
    protected $casts = [
        ...
        'role' => 'Spinen\ConnectWise\Models\v2019_2\Sales\OpportunitySalesRoleReference',
        'notes' => 'string',
