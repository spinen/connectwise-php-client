...
/**
 * Class TicketSync Version v2018_6
 *
 ...
 * @property Spinen\ConnectWise\Models\v2018_6\Service\IntegratorLoginReference $integratorLogin
...
class TicketSync extends Model
{
    ...
    protected $casts = [
        ...
        'name' => 'string',
        'vendorType' => 'string',
        'integratorLogin' => 'Spinen\ConnectWise\Models\v2018_6\Service\IntegratorLoginReference',
