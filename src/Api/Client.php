...
class Client
{
    ...
    protected $resource_model_map = [
        ...
        'finance/accounting/batches'                      => 'Finance\AccountingBatches',
        ...
        'finance/accounting/unpostedinvoices'             => 'Finance\AccountingUnpostedInvoices',
        'finance/accounting/unpostedprocurement'          => 'Finance\AccountingUnpostedProcurement',
        'finance/agreements'                              => 'Finance\Agreement',
        'finance/agreements/types'                        => 'Finance\AgreementTypes',
        ...
        'finance/finance/taxCodes/{id}/taxCodeXRefs'      => 'Finance\TaxCodeXRef',
