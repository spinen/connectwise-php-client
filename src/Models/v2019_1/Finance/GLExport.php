...
/**
 * Class GLExport Version v2019_1
 * 
 * Model for GLExport
 *
 * @property Spinen\ConnectWise\Models\v2019_1\Finance\GLExportSettings $exportSettings
...
class GLExport extends Model
{
     ...
     */
    protected $casts = [
        'exportSettings' => 'Spinen\ConnectWise\Models\v2019_1\Finance\GLExportSettings',
        'vendors' => 'array',
        'customers' => 'array',
        'transactions' => 'array',
        'expenses' => 'array',
